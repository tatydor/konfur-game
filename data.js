...
export const step5Consequence = {
  ...
  scale: "Результат держится, поэтому открываем решение соседнему отделу. Следить придётся за одним: их случаи никто ещё не размечал.",
...
export const GAME_VERSION = "0.9.23";
