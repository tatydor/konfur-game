...
export const tasks = [
  ...
  },
  {
    ...
    seed: "Если внедрим решение для задачи «{ownTaskText}», то получим измеримый результат за два месяца. Поправь под себя.",
...
export const ui = {
  ...
  step4: {
    ...
    intro: "Решение готово, осталось довести его до людей. Виджет не единственный путь: половина хороших внедрений работает в фоне, и замечают их по тому, что стало легче.",
    fits: "Подходит",
  ...
  step5: {
    ...
    intro: "Пилот живёт две недели. Проверяли ровно то, что записано в твоей гипотезе, и вот что видно.",
