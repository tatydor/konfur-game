...
export const step5Consequence = {
  fix:   "Берёмся за ту самую поломку и правим её. Через две недели прогоняем ту же проверку и смотрим, сдвинулась ли цифра.",
  scale: "Расширяем пилот на весь поток и соседние команды. Риск понятный: проверяли на небольшой выборке, а на чужих случаях цифра может просесть.",
...
export const GAME_VERSION = "0.9.27";
