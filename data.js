...
export const final = {
  ...
  metaBadge: "5 из 5 · Пилот собран",
  heroTitles: {
    scale: "Решение: масштабировать",
    fix: "Решение: доработать",
    stop: "Решение: остановить",
    watch: "Решение: наблюдать"
  },
  heroSubtitles: {
    scale: "Первая проверка пройдена. Есть основание двигаться дальше.",
    fix: "Проверка показала слабое место. Доработай его и проверь снова.",
    stop: "Остановка с данными — нормальный результат пилота. Ресурсы не ушли в лишнее масштабирование.",
    watch: "Данных пока недостаточно. Зафиксируй показатель и вернись к нему после наблюдения."
  },
  cardWatchLabel: "Смотрю",
  cardTitle: "Твой пилот",
  ...
  toAnketa: "Ответить на 2 вопроса →"
};
