...
export const tasks = [
  ...
  },
  {
    ...
    card: "Опиши в двух словах. Маршрут в игре общий, зато твою задачу разберём на стенде.",
    defaultResult: "time",
    defaultCriterion: "time20",
...
export const step5Consequence = {
  ...
  stop:  "Критерий не достигнут, сигнал сам не ушёл. Пилот останавливаем, условия записываем в вики. Единственный отрицательный результат, который экономит деньги."
};
...
export const final = {
  variants: {
    ...
    stop: {
      ...
      resultShort: "гипотеза не подтвердилась",
      congrats: "Проверка завершена, пилот остановлен. Гипотеза не подтвердилась в текущих условиях, и команда сохранила ресурсы.",
